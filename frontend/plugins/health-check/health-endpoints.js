...
function setupHealthEndpoints(devServer, healthPlugin) {
  ...
  console.info('[Health Check] Setting up health endpoints...');
  ...
  console.info('[Health Check] ✓ Health endpoints ready:');
  console.info('  • GET /health         - Detailed status');
  console.info('  • GET /health/simple  - Simple OK/ERROR');
  console.info('  • GET /health/ready   - Readiness check');
  console.info('  • GET /health/live    - Liveness check');
  console.info('  • GET /health/errors  - Error details');
  console.info('  • GET /health/stats   - Statistics');
}
