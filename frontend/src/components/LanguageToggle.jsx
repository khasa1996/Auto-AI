  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        ...
        className="flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-slate-300 hover:text-[#F59E0B] border border-white/10 px-3 py-2 transition-colors"
      >
        <Globe size={14} />
