...
function LoadedVehicle({ asset, runtime, purchasable, interaction }) {
  ...
  useEffect(() => {
    ...
    playToggle('doors', interaction.doors.rearLeft, previous.doors.rearLeft, 'doors', 'rear_left_open', 'rear_left_close', 'door_rear_left_open', 'door_rear_left_close');
    playToggle('doors', interaction.doors.rearRight, previous.doors.rearRight, 'doors', 'rear_right_open', 'rear_right_close', 'door_rear_right_open', 'door_rear_right_close');
